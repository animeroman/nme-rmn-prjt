// Detects mobile devices and browsers start(...638)
!(function(b) {
  (function() {
        ...
        e &&
          ...
          0 < $('.servers-' + e).length
            ...
            ? 0 < $('.servers-mixed').length
              ? $('.servers-mixed .server-item')
                  .first()
                  .click()
              : 0 < $('.servers-dub').length &&
                $('.servers-dub .server-item')
                  .first()
                  .click()
