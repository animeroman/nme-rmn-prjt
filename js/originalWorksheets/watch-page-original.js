...
function createEpisodeList(data) {
  ...
  // Function to update dropdown for episodes
    ...
    `;
      ...
      for (let i = 0; i < Math.ceil(totalEpisodes / 100); i++) {
        ...
        <a
          data-page="${i + 1}"
          href="javascript:;"
          class="dropdown-item ep-page-item"
        >
      ...
      // Add event listener to update current-page text when an item is clicked
      ...
      dropdownItems.forEach(item => {
        item.addEventListener('click', function() {
          ...
          dropdownItems.forEach(
            el => (el.querySelector('i').style.display = 'none')
          );
  ...
  // Call the function after determining totalEpisodes
  createEpisodeDropdown(totalEpisodes);
