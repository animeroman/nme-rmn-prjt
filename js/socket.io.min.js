...
!(function(t, e) {
  ...
  (L.prototype.on = L.prototype.addEventListener = function(t, e) {
    ...
    (L.prototype.off = L.prototype.removeListener = L.prototype.removeAllListeners = L.prototype.removeEventListener = function(
      t,
      e
    ) {
        ...
        r(t, [
          {
            ...
            value: function(t) {
              return (t.type !== Et.EVENT && t.type !== Et.ACK) || !mt(t)
                ...
                : ((t.type =
                    t.type === Et.EVENT ? Et.BINARY_EVENT : Et.BINARY_ACK),
          ...
          },
          {
            ...
            value: function(t) {
              var e = '' + t.type;
              return (
                (t.type !== Et.BINARY_EVENT && t.type !== Et.BINARY_ACK) ||
                  (e += t.attachments + '-'),
                t.nsp && '/' !== t.nsp && (e += t.nsp + ','),
                null != t.id && (e += t.id),
          ...
          [
            {
              ...
              value: function(t) {
                ...
                if ('string' == typeof t) {
                  ...
                  (e = this.decodeString(t)).type === Et.BINARY_EVENT ||
                  e.type === Et.BINARY_ACK
                    ? ((this.reconstructor = new Rt(e)),
                      0 === e.attachments &&
                        y(s(a.prototype), 'emitReserved', this).call(
                          this,
                          'decoded',
                          e
                        ))
      ...
      return (
        r(i, [
          ...
          },
          {
            ...
            value: function() {
              return (
                this.connected && this.packet({ type: Et.DISCONNECT }),
                this.destroy(),
