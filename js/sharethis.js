...
(function () {
  ...
  st.log = function (data, url) {
    ...
    log = function () {
      ...
      data.ua_full_version_list =
        (ref1 = st.ua_fields) != null ? ref1.ua_full_version_list : void 0;
      data.ua_mobile = (ref2 = st.ua_fields) != null ? ref2.ua_mobile : void 0;
      data.ua_model = (ref3 = st.ua_fields) != null ? ref3.ua_model : void 0;
      data.ua_platform =
        (ref4 = st.ua_fields) != null ? ref4.ua_platform : void 0;
      data.ua_platform_version =
        (ref5 = st.ua_fields) != null ? ref5.ua_platform_version : void 0;
      page_info =
        ((ref6 = window.__stdos__) != null
          ? (ref7 = ref6.data) != null
            ? ref7.pageInfo
            : void 0
          : void 0) || {};
  ...
  st.share = function (config) {
    ...
    (channel_is_ssb = config.channel_is_ssb),
      (channels_displayed = config.channels_displayed),
    ...
    redirects = {
      ...
      houzz:
        "https://www.houzz.com/imageClipperUpload?" +
        st.qs({
          link: share_url,
          source: "link",
          hzid: "",
      ...
      microsoftteams:
        "https://teams.microsoft.com/l/entity/com.microsoft.teamspace.tab.url.share?" +
        st.qs({
          webUrl: share_url,
          appName: title,
        }),
...
(function () {
  ...
  for (i = 0, len = scripts.length; i < len; i++) {
    ...
    if (/\/js\/sharethis.js/.test(src)) {
      ...
      st.ssb =
        (ref4 = /ssb=([a-zA-Z0-9-]+)/.exec(src)) != null ? ref4[1] : void 0;
      st.account =
...
__stdos__.logger = {
  ...
  log: function (a, h, j) {
    ...
    __stdos__.data.getEUConsent(function (consent) {
              ...
              try {
                ...
                if (typeof res !== "undefined") {
                  ...
                  if (res.fpestid) {
                    ...
                    var fpestid_cookie = __stdos__.data.parseCookie(
                      "fpestid",
                      document.cookie,
                    );
                    try {
                  ...
                  if (res.status === "true") {
                    ...
                    try {
                      if (
                        ...
                        window.location.href.endsWith("st_debug=true")
                      ) {
                        st_debug = true;
                      }
      ...
      user_agent_data
        .getHighEntropyValues(high_entropy_fields)
        .then((high_entropy_values) => {
          try {
            if (Array.isArray(high_entropy_values.fullVersionList)) {
              ...
              g +=
                "&ua_full_version_list=" +
                encodeURIComponent(ua_full_version_list);
            ...
            if (high_entropy_values.platformVersion) {
              ...
              g +=
                "&ua_platform_version=" +
                encodeURIComponent(ua_platform_version);
...
(function () {
  ...
  st.loadSsb = function ($el, config, load) {
    ...
    (num_ssb_networks = config.num_ssb_networks),
    ...
    _xhr.open(
      "GET",
      "https://datasphere-sbsvc.sharethis.com?n=" + num_ssb_networks + "&debug",
    );
    ...
    _xhr.onload = function () {
      ...
      if ((ref = _xhr.response) != null ? ref.buttons : void 0) {
        config.networks =
          (ref1 = _xhr.response) != null ? ref1.buttons : void 0;
      }
...
(function () {
  ...
  st.loader["gdpr-compliance-tool-v2"] = function (config) {
    ...
    if (
      ...
      Shopify !== null &&
      void 0 === (Shopify.designMode != null) &&
      preview === true
    ) {
      return;
    }
...
(function () {
  ...
  load = function ($el, config) {
    ...
    st.addClass($el, [
      ...
      fade_in ? "st-hidden" : void 0,
      true === preview ? "st-preview" : void 0,
...
(function () {
  ...
  load = function ($el, config) {
    ...
    network_css +=
      "#" +
      id +
      " .st-btn[data-network='copy']:hover {\n  width: max-content;\n}";
    if (network === "blm") {
      network_css +=
...
(function () {
  window.__sharethis__.md5 = "472c788ac75f26dc43bb445fb8c676b7";
})();
